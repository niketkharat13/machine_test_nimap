...
const User = (props) => {
    ...
    const logoutBtn = (<button className='btn-secondary btn mt-3' onClick={logout}>Logout</button>);
    return (
        <>
            <NavBar/>
            <Container className="mt-5">
                    ...
                    !isChangePWD ? 
                        ...
                        {({ errors, touched }) => (
                            <Form>
                                ...
                                {isChangePWD ?  <Row>
                                    <Col md={2}>
                                        <button type="submit" className='btn-primary btn mt-3'>Save Password</button>
                                    </Col>
                                    <Col md={1}>
                                        {logoutBtn}
                                    </Col>
               ...
               {!isChangePWD ? 
                    <Row> 
                        <Col md={2}>
                                <button className='btn-secondary btn mt-3' onClick={() => setIsChangePWD(true)}>Change Password</button>
                        </Col>
                        <Col md={1}>
                                {logoutBtn} 
                        </Col> 
